                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="center">
                                ...
                                <a class="btn btn-primary" href="{{URL::to('/blog-verification/'.$v_blog->blog_id)}}" title="Press to Verified">
                                    <i class="halflings-icon white thumbs-up"></i>                                            
                                </a>
                                <a class="btn btn-danger" href="{{URL::to('/delete-bloger-content/'.$v_blog->blog_id)}}" title="Delete" onclick="return check_delete()">
